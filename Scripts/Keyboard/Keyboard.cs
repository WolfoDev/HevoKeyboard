...
namespace HoloKeyboard
{
    ...
    public class Keyboard : Singleton<Keyboard>
    {
        ...
        /// <summary>
        /// The panel that contains the background of the keyboard.
        /// </summary>
        public Image BackgroundKeyboard = null;
        ...
        /// <summary>
        /// The panel that contains the number and PIN keys.
        /// </summary>
        public Image PinKeyboard = null;
        ...
        /// <summary>
        /// The default size the keyboard.
        /// </summary>
        [Header("Sizes")]
        [SerializeField]
        private float defaultKeyboardSize = 1250f;
        /// <summary>
        /// The size of the PIN keyboard type.
        /// </summary>
        [SerializeField]
        private float pinKeyboardSize = 420f;
        ...
        public void PresentKeyboard()
        {
            ...
            //TouchScreenKeyboard.Open("").active = false;
        ...
        public void ShowAlphaKeyboard()
        {
            ...
            BackgroundKeyboard.rectTransform.sizeDelta = new Vector2(defaultKeyboardSize, BackgroundKeyboard.rectTransform.sizeDelta.y);
            m_LastKeyboardLayout = LayoutType.Alpha;
        }
        ...
        /// Enable the symbol keyboard.
        /// </summary>
        public void ShowPinKeyboard()
        {
            PinKeyboard.gameObject.SetActive(true);
            BackgroundKeyboard.rectTransform.sizeDelta = new Vector2(pinKeyboardSize, BackgroundKeyboard.rectTransform.sizeDelta.y);
        }
        ...
        private void DisableAllKeyboards()
        {
            ...
            PinKeyboard.gameObject.SetActive(false);
